...
// Query to fetch all orders with customer names
...
<body class="adminpage">
    ...
    <div class="container-fluid">
        ...
        <div class="container-fluid right">
            <div class="row">
                <!-- Order Table Section -->
                <div class="col-md-9 col-lg-10 p-4 table-wrapper">
                    <h4>All Orders</h4>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Handle the approve action (Submit the form for approval)
            ...
            // Handle the delete action (Submit the form for deletion)
            ...
            if (deleteButton) {
                deleteButton.addEventListener('click', function(event) {
                    ...
                    fetch('view_orders.php', {
                        ...
                        .then(data => {
                            console.log(data);
                            window.location.href = "order_list.php"; // Redirect to order list after deletion
                        })
                        .catch(error => {
                            console.error('Error:', error);
                        });
