                ...
                <tbody>
                    <?php while ($row = $read->fetch(PDO::FETCH_ASSOC)): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="lib/editCustomer.php?CustomerID=<?php echo $row['CustomerID']; ?>">
                                    Edit
                                </a>
                                <a href="lib/deleteCustomer.php?id=<?php echo $row['CustomerID'] ?>" onclick="return confirm('Are you sure to delete?');">Delete</a>
                            </td>
                        </tr>
                ...
                <tbody>
                    <?php while ($row = $read->fetch(PDO::FETCH_ASSOC)): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="lib/editEmployee.php?UserID=<?php echo $row['UserID']; ?>">
                                    Edit
                                </a>
                                <a href="lib/deleteEmployee.php?id=<?php echo $row['UserID'] ?>" onclick="return confirm('Are you sure to delete?');">Delete</a>
                            </td>
                        </tr>
